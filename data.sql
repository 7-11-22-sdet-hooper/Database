...
(3, "What are the three pillars of scrum?", "Transparency, Inspection, Change", "Transparency, Verification, Adaptation", "Transparency, Inspection, Adaptation", "Transparency, Change, Adaptation", "C"),
...
(4, "Which of the following is an example of a sequential development model?", "spiral model", "big bang model", "waterfall model", "RAD model", "C"),
(4, "What is one advantage of using the spiral model?", "it allows space for customer testing", "it allows space for customer feedback", "it is cost-effective", "it allows space for project manager feedback", "B"),
(4, "What is the RAD model?", "an approach where no specific process is followed", "a model that divides tasks into small time frames to deliver specific features for a release", "an approach which uses prototyping and iterative delivery to create quality products quicker", "a risk analysis development approach that combines the waterfall model and an iterative model","C"),
